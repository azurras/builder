...
4. Confirm publication before starting the next delivery phase. Spec, implementation plan, applicable runtime report, and continuity remain separate checkpoints. Do not combine those phases into one delayed commit.
