...
Do not require references to specs or implementation plans. Include those links only when they are directly useful for traceability.

## Workflow

1. Determine the active builder repo root before writing.
2. Draft the test report as Markdown with a clear H1 title.
3. Include enough raw request/response detail that another agent can understand exactly what was tested.
