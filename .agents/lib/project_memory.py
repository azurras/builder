"""Dated project work records with append-only same-day continuity."""
...
def project_path(root: Path, project: str, date: str | None = None) -> Path:
    ...
    return root.expanduser().resolve() / "docs/session-memory" / f"{day.isoformat()}-{project}.md"
